...
const Home = () => {
  return (
    <section id="home" className="bg-gray-50 min-h-screen flex flex-col justify-between">
      <motion.div
      ...
      >
        {/* Hero Section */}
        <motion.div className="flex flex-col md:flex-row items-center justify-between py-20 md:py-28" variants={fadeInUp}>
          {/* Left Content */}
          <motion.div className="text-center md:text-left md:w-1/2" variants={fadeInUp}>
          ...
          >
            <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden shadow-xl border-4 border-blue-600 hover:shadow-2xl transition transform hover:scale-105">
              <img src="Banner.jpg" alt="Matthews Gondwe" className="w-full h-full object-cover" />
            </div>
          </motion.div>
        </motion.div>
